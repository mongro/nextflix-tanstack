...
import { r as signUpAnonym } from "./actions-JL1RqNQv.js";
import { useState } from "react";
import { Link, Outlet, useNavigate } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { useQueryClient } from "@tanstack/react-query";
//#region src/components/auth/sign-up-anonym.tsx
...
//#endregion
//#region src/routes/$lang/auth/route.tsx?tsr-split=component
function Layout() {
	return /* @__PURE__ */ jsxs("div", {
		className: "flex flex-col gap-4 h-screen justify-center items-center w-full",
		children: [
			/* @__PURE__ */ jsx("div", {
				className: "w-full",
				children: /* @__PURE__ */ jsx(Outlet, {})
			}),
			/* @__PURE__ */ jsx(SignUpAnonym, {}),
			/* @__PURE__ */ jsx("div", {
